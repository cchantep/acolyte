...
abstract class AbstractStatement implements java.sql.Statement {
     ...
     * {@inheritDoc}
     */
    public int executeUpdate(final String str, final int[] a) 
        throws SQLException {
     ...
     * {@inheritDoc}
     */
    public int executeUpdate(final String str, final String[] a) 
        throws SQLException {
     ...
     * {@inheritDoc}
     */
    public boolean execute(final String str, final int i) 
        throws SQLException {
     ...
     * {@inheritDoc}
     */
    public boolean execute(final String str, final int[] a) 
        throws SQLException {
     ...
     * {@inheritDoc}
     */
    public boolean execute(final String str, final String[] a) 
        throws SQLException {
