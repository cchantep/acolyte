...
final class AbstractResultSetSpec extends Specification {
  ...
  "Wrapping" should {
    "be valid for java.sql.ResultSet" in {
      defaultSet.isWrapperFor(classOf[java.sql.ResultSet]).
  ...
  "Column update" should {
    ...
    "not be supported for simple types" in {
      (rs.updateNull(0).
        ...
        and(rs.updateBoolean(0, true).
          aka("update") must throwA[UnsupportedOperationException]).
        and(rs.updateByte(0, 1.toByte).
          aka("update") must throwA[UnsupportedOperationException]).
        and(rs.updateShort(0, 1.toShort).
          aka("update") must throwA[UnsupportedOperationException]).
        and(rs.updateInt(0, 1).
          aka("update") must throwA[UnsupportedOperationException]).
        and(rs.updateLong(0, 1.toLong).
          aka("update") must throwA[UnsupportedOperationException]).
        and(rs.updateFloat(0, 1.toFloat).
          aka("update") must throwA[UnsupportedOperationException]).
        and(rs.updateDouble(0, 1.toDouble).
          aka("update") must throwA[UnsupportedOperationException]).
        and(rs.updateBigDecimal(0, new java.math.BigDecimal("1")).
          aka("update") must throwA[UnsupportedOperationException]).
        and(rs.updateString(0, "val").
          aka("update") must throwA[UnsupportedOperationException]).
        and(rs.updateBytes(0, Array[Byte]()).
          aka("update") must throwA[UnsupportedOperationException]).
        and(rs.updateDate(0, null).
          aka("update") must throwA[UnsupportedOperationException]).
        and(rs.updateTime(0, null).
          aka("update") must throwA[UnsupportedOperationException]).
        and(rs.updateTimestamp(0, null).
          aka("update") must throwA[UnsupportedOperationException]).
        and(rs.updateObject(0, null, 0).
          aka("update") must throwA[UnsupportedOperationException]).
        and(rs.updateObject(0, null).
          aka("update") must throwA[UnsupportedOperationException]).
        and(rs.updateNull("col").
          aka("update") must throwA[UnsupportedOperationException]).
        and(rs.updateBoolean("col", true).
          aka("update") must throwA[UnsupportedOperationException]).
        and(rs.updateByte("col", 1.toByte).
          aka("update") must throwA[UnsupportedOperationException]).
        and(rs.updateShort("col", 1.toShort).
          aka("update") must throwA[UnsupportedOperationException]).
        and(rs.updateInt("col", 1).
          aka("update") must throwA[UnsupportedOperationException]).
        and(rs.updateLong("col", 1.toLong).
          aka("update") must throwA[UnsupportedOperationException]).
        and(rs.updateFloat("col", 1.toFloat).
          aka("update") must throwA[UnsupportedOperationException]).
        and(rs.updateDouble("col", 1.toDouble).
          aka("update") must throwA[UnsupportedOperationException]).
        and(rs.updateBigDecimal("col", new java.math.BigDecimal("1")).
          aka("update") must throwA[UnsupportedOperationException]).
        and(rs.updateString("col", "val").
          aka("update") must throwA[UnsupportedOperationException]).
        and(rs.updateBytes("col", Array[Byte]()).
          aka("update") must throwA[UnsupportedOperationException]).
        and(rs.updateDate("col", null).
          aka("update") must throwA[UnsupportedOperationException]).
        and(rs.updateTime("col", null).
          aka("update") must throwA[UnsupportedOperationException]).
        and(rs.updateTimestamp("col", null).
          aka("update") must throwA[UnsupportedOperationException]).
        and(rs.updateObject("col", null, 0).
          aka("update") must throwA[UnsupportedOperationException]).
        and(rs.updateObject("col", null).
          aka("update") must throwA[UnsupportedOperationException]).
        and(rs.updateRef(0, null).
          aka("update") must throwA[UnsupportedOperationException]).
        and(rs.updateRef("col", null).
          aka("update") must throwA[UnsupportedOperationException]).
        and(rs.updateArray(0, null).
          aka("update") must throwA[UnsupportedOperationException]).
        and(rs.updateArray("col", null).
          aka("update") must throwA[UnsupportedOperationException]).
        and(rs.updateRowId(0, null).
          aka("update") must throwA[UnsupportedOperationException]).
        and(rs.updateRowId("col", null).
          aka("update") must throwA[UnsupportedOperationException]).
        and(rs.updateNString(0, "val").
          aka("update") must throwA[UnsupportedOperationException]).
        and(rs.updateNString("col", "val").
          aka("update") must throwA[UnsupportedOperationException])
    ...
    "not supported for streams" in {
      (rs.updateAsciiStream(0, null, 0).
        aka("update") must throwA[UnsupportedOperationException]).
        and(rs.updateBinaryStream(0, null, 0).
          aka("update") must throwA[UnsupportedOperationException]).
        and(rs.updateCharacterStream(0, null, 0).
          aka("update") must throwA[UnsupportedOperationException]).
        and(rs.updateAsciiStream("col", null, 0).
          aka("update") must throwA[UnsupportedOperationException]).
        and(rs.updateBinaryStream("col", null, 0).
          aka("update") must throwA[UnsupportedOperationException]).
        and(rs.updateCharacterStream("col", null, 0).
          aka("update") must throwA[UnsupportedOperationException]).
        and(rs.updateBlob(0, null.asInstanceOf[java.sql.Blob]).
          aka("update") must throwA[UnsupportedOperationException]).
        and(rs.updateBlob("col", null.asInstanceOf[java.sql.Blob]).
          aka("update") must throwA[UnsupportedOperationException]).
        and(rs.updateClob(0, null.asInstanceOf[java.sql.Clob]).
          aka("update") must throwA[UnsupportedOperationException]).
        and(rs.updateClob("col", null.asInstanceOf[java.sql.Clob]).
          aka("update") must throwA[UnsupportedOperationException]).
        and(rs.updateNClob(0, null.asInstanceOf[java.sql.NClob]).
          aka("update") must throwA[UnsupportedOperationException]).
        and(rs.updateNClob("col", null.asInstanceOf[java.sql.NClob]).
          aka("update") must throwA[UnsupportedOperationException]).
        and(rs.updateSQLXML(0, null).
          aka("update") must throwA[UnsupportedOperationException]).
        and(rs.updateSQLXML("col", null).
          aka("update") must throwA[UnsupportedOperationException]).
        and(rs.updateNCharacterStream(0, null).
          aka("update") must throwA[UnsupportedOperationException]).
        and(rs.updateNCharacterStream("col", null).
          aka("update") must throwA[UnsupportedOperationException]).
        and(rs.updateBinaryStream(0, null).
          aka("update") must throwA[UnsupportedOperationException]).
        and(rs.updateBinaryStream("col", null).
          aka("update") must throwA[UnsupportedOperationException]).
        and(rs.updateCharacterStream(0, null).
          aka("update") must throwA[UnsupportedOperationException]).
        and(rs.updateCharacterStream("col", null).
          aka("update") must throwA[UnsupportedOperationException]).
        and(rs.updateAsciiStream(0, null).
          aka("update") must throwA[UnsupportedOperationException]).
        and(rs.updateAsciiStream("col", null).
          aka("update") must throwA[UnsupportedOperationException]).
        and(rs.updateBlob(0, null.asInstanceOf[java.io.InputStream]).
          aka("update") must throwA[UnsupportedOperationException]).
        and(rs.updateBlob("col", null.asInstanceOf[java.io.InputStream]).
          aka("update") must throwA[UnsupportedOperationException]).
        and(rs.updateClob(0, null.asInstanceOf[java.io.Reader]).
          aka("update") must throwA[UnsupportedOperationException]).
        and(rs.updateClob("col", null.asInstanceOf[java.io.Reader]).
          aka("update") must throwA[UnsupportedOperationException]).
        and(rs.updateNClob(0, null.asInstanceOf[java.io.Reader]).
          aka("update") must throwA[UnsupportedOperationException]).
        and(rs.updateNClob("col", null.asInstanceOf[java.io.Reader]).
          aka("update") must throwA[UnsupportedOperationException]).
        and(rs.updateNCharacterStream(0, null).
          aka("update") must throwA[UnsupportedOperationException]).
        and(rs.updateNCharacterStream("col", null).
        ...
        and(rs.updateAsciiStream("col", null).
          aka("update") must throwA[UnsupportedOperationException]).
        and(rs.updateBlob(0, null, 0).
          aka("update") must throwA[UnsupportedOperationException]).
        and(rs.updateBlob("col", null, 0).
          aka("update") must throwA[UnsupportedOperationException]).
        and(rs.updateClob(0, null, 0).
          aka("update") must throwA[UnsupportedOperationException]).
        and(rs.updateClob("col", null, 0).
          aka("update") must throwA[UnsupportedOperationException]).
        and(rs.updateNClob(0, null, 0).
          aka("update") must throwA[UnsupportedOperationException]).
        and(rs.updateNClob("col", null, 0).
          aka("update") must throwA[UnsupportedOperationException])
